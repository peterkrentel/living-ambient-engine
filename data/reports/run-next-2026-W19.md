# Run next — advisory (2026-W19)

Generated (report): 2026-05-10T02:46:32.975941+00:00
**Correlate bundle `generated_at`:** 2026-05-10T02:46:32.644523Z

## How to read this

This file is **machine-assembled** from `data/suggestions.json` and the **brand** channel audit (`audit-2026-W19.md`).  It is **not** causal advice — see *Packaging & confounders* below.
...
- **Overall avg retention:** 27.22%
- **Overall avg watch min / video (window):** 7.695
- **Videos analyzed:** 95 with views / 354 total

## Evidence (paths)

- **Suggestions:** `data/suggestions.json`
- **Channel audit:** `data/reports/audit-2026-W19.md`
...
- `data/analytics_personal.json` — **116** videos in snapshot; `fetched_at`: 2026-05-04T13:57:32.962964+00:00
