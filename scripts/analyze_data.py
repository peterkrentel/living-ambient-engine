...
_default = "data/analytics.json"
_path = os.environ.get("ANALYTICS_JSON_PATH", _default).strip() or _default
if not os.path.isabs(_path):
    _path = os.path.join(_REPO_ROOT, _path)
