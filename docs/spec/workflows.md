...
| Runner GGUF advisory (v0) | `data/reports/agent-insight-YYYY-WW-brand-runner.md` | Instruct GGUF on the workflow runner (default Qwen2.5-1.5B q4 path); lean CONTEXT includes **deterministic facts** JSON; stub if `llama-cpp-python` / model missing |
