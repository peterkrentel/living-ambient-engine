...
| Done (v1+) | **Personal analytics:** [`analytics-personal.yml`](../.github/workflows/analytics-personal.yml) → `analytics_personal.json` + `*-personal.md` + `audit-*-personal.md` + **`suggestions_personal.json`** + **`run-next-*-personal.md`** ([`PERSONAL_ANALYTICS.md`](PERSONAL_ANALYTICS.md)). |
